...
Swagger documentation is available for all endpoints. It is recommended to go to [swagger editor](www.editor.swagger.io) and copy and paste swagger.yaml file into the terminal
